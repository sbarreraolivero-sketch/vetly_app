// Update Google Calendar Event Edge Function
...
Deno.serve(async (req: Request) => {
    ...
    try {
        ...
        const { google_event_id, title, description, start, end } = body;
        ...
        if (start) eventBody.start = { dateTime: start };
        if (end) eventBody.end = { dateTime: end };
