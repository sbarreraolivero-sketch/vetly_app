...
interface AuthContextType {
    ...
    signUp: (email: string, password: string, fullName: string, clinicName: string, selectedPlan: string, cardToken?: string | null, paymentProvider?: string, referralCode?: string, turnstileToken?: string, attribution?: Record<string, unknown>) => Promise<{ error: Error | null }>
...
export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    const signUp = async (email: string, password: string, fullName: string, clinicName: string, selectedPlan: string, cardToken?: string | null, paymentProvider?: string, referralCode?: string, turnstileToken?: string, attribution?: Record<string, unknown>) => {
        try {
