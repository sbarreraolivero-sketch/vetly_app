            ...
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-soft p-8 md:p-12 border border-primary-100">
                ...
                <div className="prose prose-primary max-w-none text-gray-700">
                    ...
                    <p className="text-lg leading-relaxed mb-6">
                        Bienvenido a <strong>Vetly AI</strong>. Al registrarse, acceder y utilizar nuestra plataforma de Inteligencia Artificial para la gestión y automatización de procesos clínicos, usted ("El Cliente" o "La Clínica") acepta los siguientes Términos y Condiciones.
                    </p>

                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">1. Uso del Servicio y Licencia</h2>
                    <ul className="list-disc pl-6 space-y-2 mb-6">
                        <li><strong>Descripción:</strong> Vetly AI proporciona herramientas SaaS (Software as a Service) incluyendo agendamiento, CRM, Finanzas y un Agente Inteligente operando vías WhatsApp.</li>
                    ...
                    <p className="mb-6">
                        Nuestros servicios automatizados de mensajería dependen de proveedores de telecomunicaciones como Ycloud y Meta (WhatsApp Cloud API). Vetly AI no es responsable de bloqueos, interrupciones al servicio de Meta, suspensiones de número por envío indebido de spam o fallas exclusivas ajenas a nuestra infraestructura.
                    </p>

                    <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">4. Privacidad, Confidencialidad y Propiedad Intelectual</h2>
                    <p className="mb-6">
                        Toda la información del paciente se procesa conforme a normativas de protección de datos vigentes y a nuestra <strong>Política de Privacidad</strong> conjunta. Los derechos de nuestro código, logotipos, diseño "Soft Luxury" y manual de marca pertenecen exclusivamente a Vetly AI.
                    </p>
