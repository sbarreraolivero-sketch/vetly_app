...
const plans = [
    {
        ...
        price: 33,
        period: '/mes',
        description: 'Todo lo necesario para gestionar tu clínica sin depender de mensajería.',
        highlight: false,
        icon: Sparkles,
        features: [
            '1 usuario · 1 agenda',
    ...
    },
    {
        ...
        price: 89,
        period: '/mes',
        description: 'Agente IA en WhatsApp + gestión completa para quien trabaja solo.',
        highlight: false,
        icon: Zap,
        features: [
            '2 usuarios · 1 agenda',
    ...
    },
    {
        ...
        price: 149,
        period: '/mes',
        description: 'La solución completa para captar, retener y automatizar tu clínica veterinaria.',
        highlight: true,
        icon: Zap,
        features: [
    ...
    },
    {
        ...
        price: 349,
        period: '/mes',
        description: 'Infraestructura empresarial para controlar y escalar múltiples sedes.',
        highlight: false,
        icon: Crown,
        features: [
