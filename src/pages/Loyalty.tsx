                ...
                <div className="p-5 sm:p-8">
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                        <div className="flex-1 min-w-0">
                            <p className="text-xs font-black uppercase tracking-widest text-violet-200 mb-1.5">Marketing</p>
                            <h1 className="text-xl sm:text-3xl font-extrabold tracking-tight text-white">Fidelización & Referidos</h1>
                            <p className="text-xs sm:text-sm text-violet-100/80 font-light mt-1">Programa de lealtad y crecimiento orgánico de tu clínica.</p>
                        </div>
