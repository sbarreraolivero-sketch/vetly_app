                    ...
                    <div className="px-5 pt-4 pb-3 border-b border-silk-beige bg-ivory/60">
                        ...
                        {isClosed ? (
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 text-sm text-charcoal/60 hover:text-primary-600 transition-colors group"
                            >
                                <span className="font-semibold">{openingBalance > 0 ? fmt(openingBalance) : 'Sin especificar'}</span>
